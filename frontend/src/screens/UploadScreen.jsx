...
export default function UploadScreen({
  ...
  return (
    <main className="box-border w-full overflow-x-clip">
      <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center px-4 pb-12 pt-24 sm:px-6 sm:pb-16 sm:pt-28 lg:px-8 lg:pt-32">
        <input
          ref={inputRef}
          type="file"
          accept="video/*"
        ...
        {!devMode && <div className="w-full max-w-sm mb-4 animate-fade-up" style={{ animationDelay: '0.35s' }}>
